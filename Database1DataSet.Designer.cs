...
namespace Diary {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class Table1DataTable : global::System.Data.TypedTableBase<Table1Row> {
            ...
            private global::System.Data.DataColumn columnEvent_number;
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public global::System.Data.DataColumn Event_numberColumn {
                get {
                    return this.columnEvent_number;
                }
            }
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row AddTable1Row(string Event_name, System.DateTime Date, string Description) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public Table1Row FindByEvent_number(int Event_number) {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            internal void InitVars() {
                this.columnEvent_number = base.Columns["Event number"];
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            private void InitClass() {
                this.columnEvent_number = new global::System.Data.DataColumn("Event number", typeof(int), null, global::System.Data.MappingType.Element);
                base.Columns.Add(this.columnEvent_number);
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnEvent_number}, true));
                this.columnEvent_number.AutoIncrement = true;
                this.columnEvent_number.AutoIncrementSeed = 1;
                this.columnEvent_number.AllowDBNull = false;
                this.columnEvent_number.Unique = true;
        ...
        public partial class Table1Row : global::System.Data.DataRow {
            ...
            public int Event_number {
                get {
                    return ((int)(this[this.tableTable1.Event_numberColumn]));
                }
                set {
                    this[this.tableTable1.Event_numberColumn] = value;
                }
            }
            ...
            public string Event_name {
                get {
                    return ((string)(this[this.tableTable1.Event_nameColumn]));
                }
                set {
                    this[this.tableTable1.Event_nameColumn] = value;
                }
            }
...
namespace Diary.Database1DataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            tableMapping.ColumnMappings.Add("Event number", "Event number");
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table1] WHERE (([Event number] = @Original_Event_number) AND (" +
                "[Date] = @Original_Date))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Event_number", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Event number", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Date", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Date", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table1] ([Event number], [Event name], [Date], [Description]) " +
                "VALUES (@Event_number, @Event_name, @Date, @Description);\r\nSELECT [Event number]" +
                ", [Event name], Date, Description FROM Table1 WHERE ([Event number] = @Event_num" +
                "ber)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Event_number", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Event number", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Event_name", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Event name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table1] SET [Event number] = @Event_number, [Event name] = @Event_name, [Date] = @Date, [Description] = @Description WHERE (([Event number] = @Original_Event_number) AND ([Date] = @Original_Date));
SELECT [Event number], [Event name], Date, Description FROM Table1 WHERE ([Event number] = @Event_number)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Event_number", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Event number", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Event_name", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Event name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Event_number", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Event number", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Diary.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Event number], [Event name], Date, Description FROM dbo.Table1";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Table1] ([Event number], [Event name], [Date], [Description]) " +
                "VALUES (@Event_number, @Event_name, @Date, @Description);\r\nSELECT [Event number]" +
                ", [Event name], Date, Description FROM Table1 WHERE ([Event number] = @Event_num" +
                "ber)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Event_number", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Event number", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Event_name", global::System.Data.SqlDbType.Text, 2147483647, global::System.Data.ParameterDirection.Input, 0, 0, "Event name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        public virtual int Delete(int Original_Event_number, System.DateTime Original_Date) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Event_number));
        ...
        public virtual int Insert(int Event_number, string Event_name, System.DateTime Date, string Description) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Event_number));
            if ((Event_name == null)) {
        ...
        public virtual int Update(int Event_number, string Event_name, System.DateTime Date, string Description, int Original_Event_number, System.DateTime Original_Date) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Event_number));
            if ((Event_name == null)) {
                throw new global::System.ArgumentNullException("Event_name");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Event_number));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Event_name, System.DateTime Date, string Description, int Original_Event_number, System.DateTime Original_Date) {
            return this.Update(Original_Event_number, Event_name, Date, Description, Original_Event_number, Original_Date);
        }
        ...
        public virtual int Insert1(int Event_number, string Event_name, System.DateTime Date, string Description) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[1];
            command.Parameters[0].Value = ((int)(Event_number));
            if ((Event_name == null)) {
                throw new global::System.ArgumentNullException("Event_name");
            }
            else {
                command.Parameters[1].Value = ((string)(Event_name));
            }
